...
object SportsData{
    fun getSportsData(): ArrayList<Sport> {
        return arrayListOf(
            Sport(
                id = 1,
                titleResourceId = R.string.valorant,
                subTitleResourceId = R.string.valorant_subtitle,
                imageResourceId = R.drawable.icon_valorant,
                sportsImageBanner = R.drawable.img_valorant
            ),
            Sport(
                id = 2,
            ...
            Sport(
                id = 3, titleResourceId = R.string.badminton,
